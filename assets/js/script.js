class Propietario {
    ...
    datosPropietario() {
        return `El nombre del dueño es: ${this.propietario}. El domicilio es: ${this.direccion}. El numero telefonico de contacto es: ${this.telefono}`;
    }
}
    ...
    e.preventDefault();   
     if (tipo.value === "perro") {
        ...
        <ul>
            ...
            <li>${perro.getAnimal}, El nombre de la mascota es ${
            perro.getMascota
        },
            La enfermedad es: ${perro.getEnfermedad}</li>
        </ul>
        `;
        return;
    }    if (tipo.value === "gato") {
        ...
        <ul>
            ...
            <li>${gato.getAnimal}, El nombre de la mascota es ${gato.getMascota},
